...
const CustomSelect = (($) => {
  ...
  class CustomSelect {
    ...
    constructor(select, options) {
      ...
      this._optionSelectedClosers = `${this._options.block}__dropdown-layout`;
    ...
    _init() {
      this._$element = $(
        `<div class="${this._options.block}">
           ...
           <div class="${this._options.block}__dropdown" style="display: none;"><div class="${this._options.block}__dropdown-close"></div></div>
           <div class="${this._options.block}__dropdown-layout"></div>
         </div>`
      );
      ...
      this._$closers = this._$element.find(`.${this._options.block}__dropdown-close`);
      this._$layout = this._$element.find(`.${this._options.block}__dropdown-layout`);
    ...
    _outside(event) {
      ...
      if (
      	!$target.parents().is(this._$element)
        && !$target.is(this._$element)
      ) {
        this._hide();
      }

      if (
      	$target.hasClass('custom-select__dropdown-close') ||
      	$target.hasClass('custom-select__dropdown-layout')
      ) {
	      this._hide();
      }
